...
public class LGMainMenuViewController: LGSideMenuController {
...
//        }
    ...
    override public func rightViewWillLayoutSubviews(with size: CGSize) {
    ...
    override public var isLeftViewStatusBarHidden: Bool {
        get {
    ...
    override public var isRightViewStatusBarHidden: Bool {
        get {
